...
<div class="main">
  ...
  <div class="content">
    <div class="content_resize">
      <div class="mainbar">
        <div class="article">
          <h2><span>Hi <%=application.getAttribute("uname")%> !! (Patient)</span></h2>
          <p align="justify"> A problem arises even when more hospitals start using the Hospital Related Documentsformat because the data scattered in different documents are hard to manage. In this paper, we describe our Hospital Related Documentsgeneration and integration Open API service based on cloud computing, through which hospitals are enabled to conveniently generate documents without having to purchase proprietary software. Our Hospital Related Documentsintegration system integrates multiple  documents per patient into a single Hospital Related Documentsand physicians and patients can browse the clinical data in chronological order. Our system of Hospital Related Documentsgeneration and integration is based on cloud computing and the service is offered in Open API. Developers using different platforms thus can use our system to enhance interoperability.</p>
      ...
      <div class="sidebar">
		...
		<li><a href="U_ViewCDA.jsp">View  Documents </a></li>
		<li><a href="U_SearchKey.jsp">Search Key  </a></li>
		<li><a href="U_RequestCDA.jsp">Request for Documents</a>  </li>
        <li><a href="U_Login.jsp">Logout</a></li>
          </ul>
        </div>
