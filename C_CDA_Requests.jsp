      ...
      <div class="mainbar">
        <div class="article">
          <h2><span>Grant Access Permissions </span></h2>
            <p><em><strong>View Documents Access Permission Requests From Doctors And Grant Permissions : </strong></em></p>
            <p>&nbsp;</p>
            <table width="500" border="1" style="border-collapse:collapse" cellpadding="0" cellspacing="0"  align="center">
              <tr>
                ...
                <td width="168"><div align="center" class="style9"><span class="style50"> Patient (Report) </span></div></td>
