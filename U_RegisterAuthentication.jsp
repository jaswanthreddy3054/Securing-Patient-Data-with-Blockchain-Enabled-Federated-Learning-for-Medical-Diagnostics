...
<%
					...
					if ( rs1.next() )
					   ...
					   {
					  PreparedStatement ps=connection.prepareStatement("insert into patient(name,pass,email,mobile,addr,dob,gender,pin,location,imagess,status,searchkey) values(?,?,?,?,?,?,?,?,?,?,?,?)");
