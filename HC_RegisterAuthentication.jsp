...
<%
					...
					try {
						...
						//image = image.replace(".", "_b.");
			 			String query1="select * from healthcare_sp  where name='"+uname+"'"; 
					...
					if ( rs1.next() )
					   {
							...
							%>
							<p><a href="HC_Login.jsp">Back</a>         <a href="index.html">Home</a> </p>
					   ...
					   {
					PreparedStatement ps=connection.prepareStatement("insert into healthcare_sp(name,pass,email,mobile,addr,dob,gender,pin,location,imagess,status) values(?,?,?,?,?,?,?,?,?,?,?)");
