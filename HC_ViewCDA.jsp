    ...
    <div class="content_resize">
      <div class="mainbar">
        <div class="article">
          ...
          <p align="justify">&nbsp;</p>
          <p align="justify"><em><strong>View Reports Sent From Cloud And Request For Access Permission : </strong></em></p>
          <p>&nbsp;</p>
          <table width="500" border="1" style="border-collapse:collapse" cellpadding="0" cellspacing="0"  align="center">
            <tr>
              ...
              <td width="234"><div align="center" class="style9"><span class="style23"> Patient Name (Report) </span></div></td>
